		...
		<ul class="tabs">
			<?php if($DelPermission['result']==true):?>
   			...
   			<?php if($AddPermission['result']==true):?>
   				<li>
   					<a href="/backend/<?php echo $this->router->class;?>/add_<?php echo $this->router->method;?>" style="color:blue">
   						新增資料
   					</a>
   				</li>
   			<?php endif;?>
				...
				<table class="tablesorter" cellspacing="1"> 
					<thead> 
						<tr> 
		    				...
		    				<th style="width:50px;">建檔時間</th>
		    				<th style="width:150px;">圖檔</th>
		    				<th style="width:50px;">動作</th> 
						</tr> 
					</thead> 
					<tbody> 
						...
						<tr> 
		    				...
		    				<td><IMG alt="" src="/include/timthumb.php?src=<?php echo $row->pict?>&h=100&w=200&zc=1"></td>
		    				<td>
